<div class="header">
   ...
   <a id="mobile_btn" class="mobile_btn float-start" href="#sidebar"><img src="/backend-files/img/icons/bar-icon.svg"
                                                                          alt=""></a>
   ...
   <ul class="nav user-menu float-end">
      <li class="nav-item dropdown d-none d-sm-block">
         <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown"><img
               src="/backend-files/img/icons/note-icon-02.svg" alt=""><span class="pulse"></span> </a>
...
<img alt="John Doe" src="/backend-files/img/user.jpg" class="img-fluid">
      ...
      <li class="nav-item dropdown d-none d-sm-block">
         <a href="javascript:void(0);" id="open_msg_box" class="hasnotifications nav-link"><img
               src="/backend-files/img/icons/note-icon-01.svg" alt=""><span class="pulse"></span> </a>
      </li>
      <li class="nav-item dropdown has-arrow user-profile-list">
         <a href="#" class="dropdown-toggle nav-link user-link" data-bs-toggle="dropdown">
            <div class="user-names">
               <h5><?= Yii::$app->user->identity->first_name . " " . Yii::$app->user->identity->last_name ?> </h5>
               <span><?= Yii::$app->user->identity->getRoleName() ?></span>
            </div>
            <span class="user-img">
<img src="/backend-files/img/user-06.jpg" alt="Admin">
      ...
      <li class="nav-item ">
         <a href="settings.html" class="hasnotifications nav-link"><img
               src="/backend-files/img/icons/setting-icon-01.svg" alt=""> </a>
      </li>
   </ul>
