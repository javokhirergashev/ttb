...
<div class="diagnosis-class-index">
    ...
    <p>
        <?= Html::a('Yangi tashxis sinfini qo\'shish', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
...
//                            'id',
                            ...
                            [
                                'attribute' => 'status',
                                'value' => function ($data) {
                                    if ($data->status == \common\models\DiagnosisClass::STATUS_ACTIVE) {
                                ...
                                'format' => 'raw',
                                'filter' => [\common\models\DiagnosisClass::STATUS_ACTIVE => 'Faol',\common\models\DiagnosisClass::STATUS_INACTIVE => 'Faol emas']
                            ],
                            [
