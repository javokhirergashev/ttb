...
$this->title = 'Region Uz';
$this->params['breadcrumbs'][] = $this->title;
?>
<?= Html::beginForm(['/country/region-uz/index'], 'post'); ?>
                        ...
                        [
                            ...
                            'buttons' => [
                                'buttons' => function ($url, $model) {
                                    $update = Url::to(['/country/region-uz/update', 'id' => $model->id]);
                                    $delete = Url::to(['/country/region-uz/delete', 'id' => $model->id]);
                                    $districts = Url::to(['/country/district-uz/index', 'region_id' => $model->id]);
                                    $code = <<<BUTTONS
                            <div>
                                ...
                                <a href="{$districts}" data-pjax="0" class="btn btn-primary btn-icon">
                                    <div>
