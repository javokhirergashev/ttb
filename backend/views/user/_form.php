                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <?= $form->field($model, 'status')->dropDownList([
                                        \common\models\UserCreateForm::STATUS_ACTIVE => "Active",
                                        \common\models\UserCreateForm::STATUS_INACTIVE => "InActive",
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <?= $form->field($model, 'role')->dropDownList([
                                        \common\models\UserCreateForm::ROLE_ADMIN => "admin",
                                        \common\models\UserCreateForm::ROLE_MANAGER => "menejer",
                                        \common\models\UserCreateForm::ROLE_STATIST => "statist",
                                        \common\models\UserCreateForm::ROLE_DOCTOR => "shifokor",
                                        \common\models\UserCreateForm::ROLE_NURSE => "Hamshira",
