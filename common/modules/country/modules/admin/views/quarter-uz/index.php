...
$this->title = 'Quarter Uz';
$this->params['breadcrumbs'][] = $this->title;
?>
<?= Html::beginForm(['/country/quarter-uz/index'], 'post'); ?>
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'headerOptions' => ['style' => 'width:80px;text-align:center'],
                            'contentOptions' => ['style' => 'text-align:center'],
                            'value' => 'district.name.' . \Yii::$app->language
                        ],
                        [
                            'attribute' => 'name',
                            'headerOptions' => ['style' => 'width:80px;text-align:center'],
                        ...
                        [
                            ...
                            'buttons' => [
                                'buttons' => function ($url, $model) {
                                    $update = Url::to(['/country/quarter-uz/update', 'id' => $model->id]);
                                    $delete = Url::to(['/country/quarter-uz/delete', 'id' => $model->id]);
                                    $code = <<<BUTTONS
                            <div>
