...
use backend\assets\DropdownTreeListAsset;


/**
 * @var $this \yii\web\View
 * @var $widget \backend\widgets\DropdownTreeWidget
 * @var $htmlData string
 */
                ...
                <div class="tree-header">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control search-input" name="search-input" type="text"
                                   placeholder="<?= (isset($widget->searchPanel['placeholder']) ? $widget->searchPanel['placeholder'] : ''); ?>"/>
                        </div>
                    </div>
                </div>
                <?php
