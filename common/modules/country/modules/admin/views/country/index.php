...
/* @var $searchModel \common\modules\country\models\search\CountrySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
$this->title = 'Country';
$this->params['breadcrumbs'][] = $this->title;
?>
<?= Html::beginForm(['/country/country/index'], 'post'); ?>
                        ...
                        [
                            ...
                            'buttons' => [
                                'buttons' => function ($url, $model) {
                                    $update = Url::to(['/country/country/update', 'id' => $model->id]);
                                    $delete = Url::to(['/country/country/delete', 'id' => $model->id]);
                                    $code = <<<BUTTONS
                            <div>
