...
/** @var common\models\search\DisablityClassSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Nogironlik sinflari';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="disablity-class-index">
    ...
    <p>
        <?= Html::a('Yangi nogronlik sinfini qo\'shish', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
...
//                            'id',
                            ...
                            [
                                'attribute' => 'status',
                                'value' => function ($data) {
                                    if ($data->status == \common\models\DisablityClass::STATUS_ACTIVE) {
                                ...
                                'format' => 'raw',
                                'filter' => [\common\models\DisablityClass::STATUS_ACTIVE => 'Faol', \common\models\DisablityClass::STATUS_INACTIVE => 'Faol emas']
                            ],
                            [
