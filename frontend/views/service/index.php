               ...
               <div class="row">
                  ...
                  <div class="col-lg-12 col-sm-12 mb-3">
                     ...
                     echo DateTimePicker::widget([
                        ...
                        'options' => ['placeholder' => 'Navbatga yozilish vaqtini tanlang'],
                        'convertFormat' => true,
                        'pluginOptions' => [
                           ...
                           'endDate' => date('Y-m-d H:i', strtotime(date('Y-m-d H:i',) . '+7 day')),
                           'minuteStep' => 20,
                           'removeButton' => true,
                           'clearBtn' => false,
                           'hoursEnabled' => '9,10,11,12,14,15,16,17,18', // Specify the hours to enable
                        ],
                     ]);
                     ?>
                  </div>
